...
<div class="post-note">
	<a href="<? echo $sAu['link'] ?>"><? echo $sAu['name'] ?></a> created a <a href="<? echo $cLink.'/'.$sIn['uname'].'/'.$sIn['n'] ?>">natal chart</a>
	...
	<div class="post-thumbs">
		<div class="post-thumb-img"><div class="post-thumb-img-inner">
			<div class="post-thumb-btns">
				<div class="post-thumb-view-photo" data-href="<? echo $cLink.'/'.$sIn['uname'].'/'.$sIn['n'] ?>"><span class="fa fa-search"></span></div>
				<div class="post-thumb-link" data-href="<? echo $cLink.'/'.$sIn['uname'].'/'.$sIn['n'] ?>"><span class="fa fa-link"></span></div>
			</div>
			<img class="post-thumb" src="<? echo zBg.'/zodiac-art-'.$sIn['thumb'].'.jpg' ?>"/>
		</div></div>
	</div>
	<div class="post-details">
		<div class="post-title"><a href="<? echo $cLink.'/'.$sIn['uname'].'/'.$sIn['n'] ?>"><? echo $sIn['name'] ?></a></div>
