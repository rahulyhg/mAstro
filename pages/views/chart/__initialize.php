...
$filename = $iid.".png";
$grids_filename = "./data/{$iid}_grids.png";
$grids_filename2 = "./data/{$iid}_grids_2.png";
$chartwheel_filename = "./data/{$iid}_wheel.png";
$chartwheel_filename2 = "./data/{$iid}_wheel_2.png";
$grids_fileurl = MAIN_URL."/data/{$iid}_grids.png";
$chartwheel_fileurl = MAIN_URL."/data/{$iid}_wheel.png";
$grids_fileurl2 = MAIN_URL."/data/{$iid}_grids2.png";
$chartwheel_fileurl2 = MAIN_URL."/data/{$iid}_wheel2.png";
...
//if (!file_exists($grids_filename)) include __ASTRO.'/natal_grid_1_pdf.php';
