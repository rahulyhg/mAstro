...
//imageline($im, $x1 + $center_pt, $y1 + $center_pt, $x2 + $center_pt, $y2 + $center_pt, $dark);
$x1-=24; $y1+=7;
drawboldtext($im, 16, 0, $x1 + $center_pt, $y1 + $center_pt, $dark, __ASTRO.'/HamburgSymbols.ttf', chr($pl_glyph[15]), 1);
...
//imageline($im, $x1 + $center_pt, $y1 + $center_pt, $x2 + $center_pt, $y2 + $center_pt, $dark);
$x2-=6; $y2-=6;
drawboldtext($im, 16, 0, $x2 + $center_pt, $y2 + $center_pt, $dark, __ASTRO.'/HamburgSymbols.ttf', chr($pl_glyph[16]), 1);
...
// put signs around chartwheel
  ...
  for ($i = 1; $i <= 12; $i++)
  {
    ...
    drawboldtext($im, 16, 0, $x1 + $center_pt, $y1 + $center_pt, $clr_to_use, __ASTRO.'/HamburgSymbols.ttf', chr($sign_glyph[$i]), 1);
  }
